...
<svelte:head>
    ...
    content="Predict the winners of WCA Competitions">
</svelte:head>
...
<div class="min-h-screen bg-gradient-to-br">
    <div class="mx-auto max-w-5xl px-4 py-12">
        <div class="flex items-center justify-between mb-10">
            ...
            <a
                href="/login"
                class="rounded-full bg-blue-600 px-6 py-2 text-sm font-semibold text-white transition-colors duration-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
                Login
            </a>
        </div>
